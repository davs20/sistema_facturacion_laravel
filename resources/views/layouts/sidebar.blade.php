  ...
  <section class="sidebar">
    <div class="user-panel">
      <div class="pull-left image">
        <img src="./img/anakinskylwalker.png')}}" class="img-circle" alt="User Image" />
      </div>
      ...
      <li class="treeview">
          <a href="#"><i class='fa fa-book'></i> <span>Inventario</span> <i class="fa fa-angle-left pull-right"></i></a>
            <ul class="treeview-menu">
                ...
                <li><a href="{{url('/descuento')}}" class="ajax-request">Descuentos</a></li>
                <li><a href="/inventario/unidades/unidades.php" class="ajax-request">Unidades</a></li>                 
